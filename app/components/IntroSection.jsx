        ...
        <div className="grid grid-cols-1 sm:grid-cols-12">
            <div className="col-span-7 place-self-cente sm:text-left">
                <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold">
                   <span className="text-transparent bg-clip-text bg-gradient-to-br from-orange-400 to-orange-800">
                      A Look into {" "}
                    </span>
                    <div>
                      <TypeAnimation
                ...
                <button className='px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-orange-500 to-orange-800 hover:bg-slate-800 text-white mt-3'>
                  <span className='block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2'>Download CV</span>
                </button>
                </div>
            </div>
            <div className="col-span-5 place-self-center mt-4 lg:mt-0">
                <div className="rounded-full bg-[#282828] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px]">
                  <Image
                    src="/img/camera.png"
                    alt="self image"
